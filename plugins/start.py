    ...
    if len(text)>7:
        ...
        for msg in messages:
            ...
            try:                
                ...
                pass
                ti = datetime.now() + timedelta(seconds = 60)
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                    [
                        InlineKeyboardButton("𝙶𝚁𝙾𝚄𝙿", url="https://t.me/+0i9k0q9Uv4RkMTg1"),
                        InlineKeyboardButton("𝙲𝙷𝙰𝙽𝙽𝙴𝙻", url="https://t.me/+J_GTXBS3AohiMDU1")                        
                    ],
                    [
